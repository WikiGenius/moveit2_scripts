...
int main(int argc, char **argv) {
  ...
  // std::vector<double> home_position = {1.57, 0.0, 0.7, 0.7, 0.0, 0.0};
  // std::vector<double> home_position = {-1.57, 0.0, 1.57, 0.0, 0.0, 0.0};
  // std::vector<double> home_position = {-3.14, -3.14, 0, 0.0, 0.0, 0.0}; //collision -> fail
  std::vector<double> home_position = {-1.57, -1.57, 0, -1.57, 0.0, 1.57}; 
